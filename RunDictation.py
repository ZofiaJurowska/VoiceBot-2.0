...
from dictation.service.sync_recognizer import SyncRecognizer
from dictation.utils.service_utils import ServiceUtils
from dictation.utils.audio_loader import AudioLoader
import sys
...
def asr(input_file: [str or Path]):
    results = " "
    ap = AddressProvider()
    address = ap.get("asr-pl")
    args = asr_args(address, input_file)
